        ...
        loadQuestion();
            ...
            function showResult() {
                ...
                if (percentage === 100) {
                    ...
                    message = "Відмінний результат! Ви вже близькі до майстерності! Для ще кращого результату радимо повторити білети №2, №7(2), №8(2), №9(2).";
                    } else if (percentage >= 50) {
                    message = "Гарний початок! Ви маєте базові знання, які можна покращити. Рекомендуємо звернути увагу на білети №2, №7(2), №8(2), №9(2).";
                    message += `<button onclick="window.location.href='Key_part_3.html'">Проаналізувати результати тестування</button>`;
                } else {
                    message = "Не засмучуйтесь! Помилки – це шлях до успіху. Продовжуйте навчання та повторіть білети №2, №7(2), №8(2), №9(2).";
                    message += `<button onclick="window.location.href='Key_part_3.html'">Проаналізувати результати тестування</button>`;
                }
